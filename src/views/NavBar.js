...
const onTopNav = (path)=> path === "/camera" ? 'position-relative' : '';
...
export const NavBar = () => {
  ...
  return (
    <>
      <Navbar expand="md" className={`${scrolled ? "scrolled" : ""} ${onTopNav(location.pathname)} `} >
        <Container>
          <Navbar.Brand href="/">
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="ms-auto">
              ...
              <Link to="/camera" className={activeLink === 'skills' ? 'active navbar-link' : 'navbar-link'} onClick={() => onUpdateActiveLink('about')}>About us</Link>
